    ...
    async (req, res, next) => {
        if (req.client) {
            if (req.client.activatedApps.includes('clientUiBranding')) {
                const app = await ClientUiBrandingApp.findOne({ adminEmail: req.client.email, activated: true }).exec()
                                ...
                                Appointment.create(
                                    ...
                                    async (err, appointment) => {
                                        if (err)
                                            ...
                                            if (
                                                req.client.activatedApps.includes(
                                                    "textReminder"
                                                )
                                            ) {
                                                console.log(
                                                    "gonna try to schedule a text"
                                                );
                                                ...
                                                const sendAt = dayjs
                                                    ...
                                                    .set(
                                                        "hours",
                                                        textReminderApp.remindAt.split(
                                                            ":"
                                                        )[0]
                                                    )
                                                    .set(
