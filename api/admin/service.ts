...
serviceRouter.get('/categories/:apiKey', verifyAdminKey, handleError(ServiceController.readCategories))
...
serviceRouter.get('/services/:apiKey', verifyAdminKey, handleError(ServiceController.read))
