...
const ServiceCategorySchema: Schema<ServiceCategory, ServiceCategoryModel> =
  new Schema({
    name: {
      type: String,
      required: true,
...
export const ServiceCategory =
  (mongoose.models.ServiceCategory as ServiceCategoryModel) ||
  mongoose.model<ServiceCategory, ServiceCategoryModel>(
    "ServiceCategory",
    ServiceCategorySchema
  );
export const Service =
  (mongoose.models.Service as ServiceModel) ||
  mongoose.model<Service, ServiceModel>("Service", ServiceSchema);
